...
private:
  ...
  size_t currently_available(bool no_reserve) const;
  size_t make_available_inner(size_t size, bool no_reserve);
  size_t make_available(size_t size, bool no_reserve);
