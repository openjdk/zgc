...
ZCollectedHeap* ZCollectedHeap::heap() {
  ...
  assert(heap->kind() == CollectedHeap::ZCollectedHeap, "Not an ZCollectedHeap");
...
CollectedHeap::Name ZCollectedHeap::kind() const {
  return CollectedHeap::ZCollectedHeap;
}
...
AdaptiveSizePolicy* ZCollectedHeap::size_policy() {
  Unimplemented();
  return NULL;
}
