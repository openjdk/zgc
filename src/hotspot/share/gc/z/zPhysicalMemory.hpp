...
private:
  ...
  void nmt_commit(const ZPhysicalMemory& pmem, uintptr_t offset);
  void nmt_uncommit(const ZPhysicalMemory& pmem, uintptr_t offset);
...
public:
  ...
  void map(const ZPhysicalMemory& pmem, uintptr_t offset);
  void unmap(const ZPhysicalMemory& pmem, uintptr_t offset);

  void debug_map(const ZPhysicalMemory& pmem, uintptr_t offset);
  void debug_unmap(const ZPhysicalMemory& pmem, uintptr_t offset);
};
