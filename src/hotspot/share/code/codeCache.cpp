...
void CodeCache::nmethods_do(void f(nmethod* nm)) {
  assert_locked_or_safepoint(CodeCache_lock);
  NMethodIterator iter(false /* only_alive */, false /* only_not_unloading */);
  while(iter.next()) {
    f(iter.method());
  }
}
...
void CodeCache::do_unloading(BoolObjectClosure* is_alive, bool unloading_occurred) {
  ...
  CompiledMethodIterator iter(true /* only_alive */, false /* only_not_unloading */);
  while(iter.next()) {
...
void CodeCache::mark_scavenge_root_nmethods() {
  NMethodIterator iter(true /* only_alive */, false /* only_not_unloading */);
  while(iter.next()) {
...
void CodeCache::clear_inline_caches() {
  assert_locked_or_safepoint(CodeCache_lock);
  CompiledMethodIterator iter(true /* only_alive */, true /* only_not_unloading */);
  while(iter.next()) {
