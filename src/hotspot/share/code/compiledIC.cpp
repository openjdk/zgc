...
CompiledICLocker::CompiledICLocker(CompiledMethod* method)
  : _method(method),
    _behaviour(&Behaviours::get_behaviour<CompiledICProtectionBehaviour>()),
...
bool CompiledICLocker::is_safe(CompiledMethod* method) {
  return Behaviours::get_behaviour<CompiledICProtectionBehaviour>().is_safe(method);
}
...
bool CompiledICLocker::is_safe(address code) {
  ...
  return Behaviours::get_behaviour<CompiledICProtectionBehaviour>().is_safe(cm);
}
