...
protected:
  ...
  volatile int _is_unloading_state;          // Local state used to keep track of whether unloading is happening or not
...
public:
  ...
  void* gc_data() const { return _gc_data; }
  void set_gc_data(void* gc_data) { _gc_data = gc_data; }
