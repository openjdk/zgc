...
class ThreadStateTransition : public StackObj {
 ...
 public:
  ...
  static inline void transition_from_native(JavaThread *thread, JavaThreadState to) {
    ...
    if (SafepointMechanism::should_process_operation(thread) || thread->is_suspend_after_native()) {
...
class ThreadInVMForHandshake : public ThreadStateTransition {
  ...
  void transition_back() {
    ...
    SafepointMechanism::process_operation_if_requested(_thread);
...
class ThreadBlockInVMWithDeadlockCheck : public ThreadStateTransition {
 ...
 public:
  ...
  ~ThreadBlockInVMWithDeadlockCheck() {
    ...
    if (SafepointMechanism::should_process_operation(_thread)) {
      release_mutex();
      SafepointMechanism::process_operation_if_requested(_thread);
    }
