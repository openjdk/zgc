 ...
 * @run main/othervm -XX:+UseZGC -Xms32M -Xmx128M -Xlog:gc,gc+heap -XX:+ZUncommit -XX:ZUncommitDelay=1 -XX:-ZAutomaticHeapSizing jdk.jfr.event.gc.detailed.TestZUncommitEvent
 */
