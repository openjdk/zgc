 ...
 * @run main/othervm -XX:+UnlockExperimentalVMOptions -XX:+UseZGC -XX:+ZUnmapBadViews -XX:ZCollectionInterval=1 -XX:-CreateCoredumpOnCrash -XX:CompileCommand=dontinline,*::mergeImpl* compiler.gcbarriers.UnsafeIntrinsicsTest
 */
